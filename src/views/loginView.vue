...
<template>
    <div class="login">
        ...
        <el-input class="mt-2" v-model="email" ref="emailInput" @keyup.enter="login" type="email" placeholder="이메일을 입력 해 주세요"/>
        <el-input class="mt-2" v-model="password" type="password" @keyup.enter="login" placeholder="비밀번호를 입력 해 주세요"/>
        <el-row justify="end">
            <el-button class="mt-2" type="info" @click="join()">회원가입</el-button>
